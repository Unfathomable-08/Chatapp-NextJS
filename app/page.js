    ...
    <>
      <div className="flex">
        ...
        <div className="ps-16 w-full">
          <div className="bg-[#3f5370] h-screen w-80 fixed left-16 py-10 px-4 text-white overflow-y-auto">
          ...
          <div className="bg-[#eeeeee] min-h-screen relative p-8 ml-80">
            <div>
              ...
              <div className="flex flex-col py-8 gap-y-3 px-4">
            ...
            <form style={{width: "calc(100vw - 128px - 320px)"}} className=" fixed bottom-0 bg-[#eeeeee] py-8">
